...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        d1 = Departament.objects.create(id_dpt=f"ONE{str(int(random.random()*99999999999))}",name_dpt="Departament of Mail", phone_number="555-12-555")
        d2 = Departament.objects.create(id_dpt=f"TWO{str(int(random.random()*99999999999))}",name_dpt="Departament of Service", phone_number="515-12-515")
        ...
        Report.objects.create(client_room=ClientRoom.objects.last(),executive=e2,attendant=at2,kind=k2,description="Baño defectuoso",response_date_time=datetime.now(),responsed=True,responce=re2)
